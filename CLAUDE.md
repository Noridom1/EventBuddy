...
- Phase plans live in [__plans__/](__plans__/) and [phases/](phases/); the system architecture doc is [documents/EventBuddy-System-Architecture.md](documents/EventBuddy-System-Architecture.md).
